...
class ShopsAdapter(private val context: Context, modelArrayList: ArrayList<Shops>) :
    BaseAdapter() {

    private var modelArrayList: ArrayList<Shops>
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.shops_item, null, true)
...
// Create a reference to a file from a Google Cloud Storage URI
        ...
        holder.address!!.text = modelArrayList[position].adress!!.take(10)
